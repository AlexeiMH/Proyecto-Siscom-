<template>
    <div class="form-container">
      ...
      <form @submit.prevent="ModificarCliente">
        ...
        <!-- Botón Agregar -->
        <button class="submit-btn" @click="ModificarCliente">Actualizar Cambios</button>
        <button class="submit-btn" @click="cerrarModal">Cerrar</button>
      </form>
    </div>
  </template>
      ...
      async agregarUsuario() {
        try {
          ...
          if (response.ok) {
            ...
            // Emitir evento para cerrar el modal después de registrar al usuario
