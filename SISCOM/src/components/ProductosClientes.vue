...
<nav class="menu">
  <RouterLink to="/Inicio" class="nav-link active">Inicio</RouterLink>
  <RouterLink to="Cotizacion2">Cotizaciones</RouterLink>
...
export default {
  ...
  methods: {
    ...
    cotizarProducto(producto) {
      ...
      this.$router.push({ path: '/Cotizacion2', query: { productoId: producto.id } });
    },
  },
};
</script>
